...
CREATE TABLE `ads_settings` (
  ...
  `ads_id_value` text NOT NULL,
  `ads_status` enum('ENABLE','DISABLE') NOT NULL,
...
CREATE TABLE `album` (
  ...
  `album_status` enum('ENABLE','DISABLE') NOT NULL DEFAULT 'ENABLE',
...
CREATE TABLE `banner_slider` (
  `banner_slider_id` int(11) NOT NULL,
  `banner_slider_name` varchar(1000) DEFAULT NULL,
  `banner_slider_name_alignment` enum('Left','Center','Right') NOT NULL DEFAULT 'Left',
  `banner_slider_image` varchar(1000) NOT NULL,
  `banner_slider_show_button` tinyint(1) NOT NULL DEFAULT 0,
  `banner_slider_button_alignment` enum('Left','Center','Right') NOT NULL DEFAULT 'Left',
  `banner_slider_button_text` varchar(20) DEFAULT NULL,
  `banner_slider_order` int(10) NOT NULL,
  `banner_slider_status` enum('ENABLE','DISABLE') NOT NULL DEFAULT 'ENABLE',
  `created_date` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `liked` (
  ...
  `like_type` enum('Music','Artist','Album','Comment','Movie') COLLATE utf8mb4_bin NOT NULL COMMENT 'music / artist / album /movie',
  `like_type_id` int(11) NOT NULL COMMENT 'music_id / album_id / artist_id /movie_id',
...
CREATE TABLE `movie` (
  ...
  `movie_status` enum('ENABLE','DISABLE') NOT NULL DEFAULT 'ENABLE',
  `created_date` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `notification_settings` (
  ...
  `settings_status` enum('ENABLE','DISABLE') NOT NULL,
  `last_updated` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `package_settings` (
  ...
  `package_name` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `package_duration` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `package_price` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'per month rate in USD',
  `package_status` enum('ENABLE','DISABLE') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ENABLE',
  `package_note` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_date` datetime NOT NULL
...
CREATE TABLE `payment_method` (
  ...
  `payment_method_currency` varchar(10) DEFAULT NULL,
  `payment_method_public_key` varchar(255) DEFAULT NULL,
  `payment_method_secret_key` varchar(255) DEFAULT NULL,
  `payment_method_status` enum('ENABLE','DISABLE') NOT NULL,
  `created_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `recently_view` (
  `recently_view_id` int(11) NOT NULL,
  `recently_view_type` enum('Music','Artist','Album','Movie') NOT NULL DEFAULT 'Music' COMMENT 'Music/Artist/Album/Movie',
  `recently_view_type_id` int(11) NOT NULL COMMENT 'music_id / artist_id / album_id	/movie_id',
  `user_id` int(11) NOT NULL,
  `created_date` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `settings_flag` (
  `settings_flag_id` int(11) NOT NULL,
  `settings_flag_name` varchar(100) NOT NULL,
  `settings_flag_value` enum('ENABLE','DISABLE') NOT NULL DEFAULT 'ENABLE',
  `created_date` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `user` (
  ...
  `user_package_id` int(11) DEFAULT 1,
  `user_package_paid_date` datetime DEFAULT NULL,
  `user_package_expiry_date` datetime DEFAULT NULL,
